module.exports = {
	...
	func (msg, cmd, bot) {
        ...
        if (!msg.member.voiceChannel || msg.member.voiceChannel.id !== msg.guild.voiceConnection.channel.id) return msg.channel.send(`\u{1f3b6} You cannot vote for a skip without being in the music bot's channel.`);
