module.exports = {
	desc: "Clears the queue without skipping current song. If a number is given, clears said amount of songs. Use \"clear last\" to remove the last added song.\nUSAGE: -clear, -clear [NUMBER], -clear last",
	lvl: "all",
	func (msg, cmd, bot) {
