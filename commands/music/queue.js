module.exports = {
	...
	func (msg, cmd, bot) {
        ...
        var contqueue = `\u{1f503} Track Loop: **${bot.music[msg.guild.id].loop?'ON':'OFF'}** Playlist Loop: **${bot.music[msg.guild.id].loopall?'ON':'OFF'}** Playlist Random: **${bot.music[msg.guild.id].random?'ON':'OFF'}**\n\n`;
